...
# allows the IV loss 1 to update the features.
...
SAVE_DIR = "random_policy_live_z_all_grads"
...
def iv_loss_fn(params, network, traj_batch, advantages, targets, config):
    ...
    x_target = phi - config["GAMMA"] * phi_next * not_done # gradient can flow through this
    # gradient for z, φ, A
