# Approximates "Two Timescale" TD learning of the random policy, where
# w = w_LSTD always holds. 
# In actuality, w=w_lstd is enforced after each training update.
...
def make_train(config):
    ...
    def train(rng):
        ...
        def _update_step(runner_state, unused):
            ...
            w_lstd = bellman_error.get_lstd_weights(evaluator, network, train_state.params, random_policy=True)
