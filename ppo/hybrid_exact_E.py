# hybrid version of ppo: exact E-loss for value, standard rollout GAE for actor
...
def make_train(base_config):
    ...
    def train(rng, hparams=None):
        ...
        def _update_step(runner_state, unused):
            ...
            # ==========================================
            # 2. EXACT DYNAMICS TARGETS (E-LOSS)
            # ==========================================
            ...
            # Stationary distribution and exact targets based on current policy
