# Based on random_policy.live_iv_all_grads.py
# allows gradients through w for both monte carlo prediction and the second stage prediction.
# allows gradients through phi for monte carlo prediction and two stage instrument tasks.
